        ...
        <section class="article-portfolio-notebook">
            ...
            <article>
                <div class="article-row-left">
                    ...
                    <p>
                        Ce projet a été réalisé pour la mairie de Breuil-le-Sec grâce à WordPress.
                    </p>
                    <ul>
                        <li><a href="http://www.breuillesec.fr/" target="_blank" title="breuillesec">www.breuillesec.fr</a></li>
                    </ul>
                </div>
